...
var Picker = _interopDefault(require('emoji-picker-react'));
...
require('@szhsin/react-menu/dist/core.css');
...
(function() {
  ...
  var runInContext = (function runInContext(context) {
    ...
    ListCache.prototype['xóa'] = listCacheDelete;
    ...
    function mapCacheDelete(key) {
      var result = getMapData(this, key)['xóa'](key);
      this.size -= result ? 1 : 0;
      return result;
    }
    ...
    MapCache.prototype['xóa'] = mapCacheDelete;
    ...
    Stack.prototype['xóa'] = stackDelete;
...
var GlobalProvider = function GlobalProvider(_ref) {
  ...
  var _useState = React.useState(currentUser),
...
var AdvancedInput = function AdvancedInput(_ref) {
  ...
  React.useEffect(function () {
    if (html != '<p></p>') {
      setEditor(draftJs.EditorState.createWithContent(contentState));
    }
  }, [html]);
  var contentBlock = htmlToDraft(html);
  var contentState = draftJs.ContentState.createFromBlockArray(contentBlock.contentBlocks);

  var _useState2 = React.useState(draftJs.EditorState.createWithContent(contentState)),
  ...
  React.useEffect(function () {
    setEditText(draftToHtml(draftJs.convertToRaw(editorState.getCurrentContent())).trim());
  }, [editorState]);
  return React__default.createElement("div", {
    ...
    onSubmit: function (e) {
      try {
        var _temp3 = function _temp3(_temp) {
          return editText != '<p></p>' ? (0, setEditor(draftJs.EditorState.createEmpty())) : _temp;
        };
    ...
    onClick: function (e) {
      try {
        var _temp6 = function _temp6(_temp4) {
          return editText != '<p></p>' ? (0, setEditor(draftJs.EditorState.createEmpty())) : _temp4;
        };
...
var DeleteModal = function DeleteModal(_ref) {
  ...
  return React__default.createElement("div", null, React__default.createElement("div", {
    ...
    onClick: onOpenModal
  }, "xóa"), React__default.createElement(reactResponsiveModal.Modal, {
    open: open,
  ...
  }, "xóa"), React__default.createElement("button", {
    className: 'cancel',
...
var CommentStructure = function CommentStructure(_ref) {
  ...
  var optionsMenu = function optionsMenu() {
    ...
    }, info.userId === currentUser.currentUserId && React__default.createElement(reactMenu.Menu, {
      menuButton: React__default.createElement("button", {
        className: 'actionsBtn'
      }, ' ', React__default.createElement("div", {
        className: 'optionIcon'
      }))
    }, React__default.createElement(reactMenu.MenuItem, {
      onClick: function onClick() {
        return globalStore.handleAction(info.comId, true);
      }
    }, "sửa"), React__default.createElement(reactMenu.MenuItem, null, React__default.createElement(DeleteModal, {
      comId: info.comId,
      parentId: parentId
    }))));
  };
  ...
  var replyBottomSection = function replyBottomSection() {
    ...
    }, "Trả lời"))))), currentUser && optionsMenu());
  };
  ...
  return React__default.createElement("div", null, editMode ? actionModeSection('edit') : replyMode ? actionModeSection('trả lời') : globalStore.replyTop ? replyTopSection() : replyBottomSection());
};
...
var CommentSection = function CommentSection(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    style: titleStyle
  }, globalStore.commentsCount || totalComments(), ' ', totalComments() === 1 ? 'Bình luận' : 'Bình luận'), React__default.createElement("hr", {
    className: 'hr-style',
    style: hrStyle
...
exports.CommentSection = CommentSection$1;
